    ...
    <div className="h-screen w-full flex">
      ...
      <div className="w-[85%] h-full p-5 rounded-lg bg-gray-50">
        ...
        <div className="sources h-[60%] w-full flex">
          ...
          {/* Alerts with Take Action */}
          <div className="h-135 w-[30%] rounded-xl mt-2 p-4 shadow-lg">
            <div>
              <h1>Active Alerts</h1>
            </div>

            <div className="alert h-55 w-full mt-5 rounded-lg flex flex-col items-start p-4 shadow-lg">
              <div className="flex">
              ...
              <p className="text-[11px] text-gray-400 mb-2">Risk 78%</p>
